...
class TestNormalizing {
    ...
    fun testNormalizing() {
        ...
        assertEquals(
            Geocoding.normalizing("中国辽宁沈阳辽中县北一路【虹桥商厦西行100米】(邮政储蓄银行北一路支行附近)"),
                Address(
                        210000000000, "辽宁省",
                        210100000000, "沈阳市",
                        210122000000, "辽中县",
        ...
        assertEquals(
            Geocoding.normalizing("辽宁 沈阳 辽中县中国辽宁 沈阳 辽中县虹桥商厦苏宁易购"),
                Address(
                        210000000000, "辽宁省",
                        210100000000, "沈阳市",
                        210122000000, "辽中县",
        ...
        // fix 3组
        assertEquals(
            Geocoding.normalizing("辽宁辽阳宏伟区辽宁省辽阳市宏伟区新村街道龙鼎山小区B区08栋3组401号"),
                Address(
                        210000000000, "辽宁省",
                        211000000000, "辽阳市",
                        211004000000, "宏伟区",
        ...
        // fix字符 —
        assertEquals(
            Geocoding.normalizing("辽宁大连甘井子区辽宁, 大连, 甘井子区, 泡崖街玉境路26号3—2—1"),
                Address(
                        210000000000, "辽宁省",
                        210200000000, "大连市",
                        210211000000, "甘井子区",
